...
datas = []
with open("input/dataC.txt") as fin:
    for line in fin:
        line = line[:-1]
        datas.append(line.split("\t"))
#清空txt
#a = open("input/dataC.txt", "w")
#a.write("")
#a.close()
...
#打开excel
workbook = openpyxl.load_workbook("output/dataC.xlsx")
...
#保存
workbook.save('output/dataC.xlsx')
