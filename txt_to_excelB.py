...
datas = []
with open("input/dataB.txt") as fin:
    for line in fin:
        line = line[:-1]
        datas.append(line.split("\t"))
#清空txt
#a = open("input/dataB.txt", "w")
#a.write("")
#a.close()
...
#打开excel
workbook = openpyxl.load_workbook("output/dataB.xlsx")
...
#保存
workbook.save('output/dataB.xlsx')
